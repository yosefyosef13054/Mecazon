...
import 'package:mecazone/tiles/categories_tile.dart';

class CategoryListScreen extends GetView<CategoryController>{
  static const route = '/CategoryListScreen';
      ...
      child: Scaffold(
          ...
          body: SizedBox(
              ...
              child: Obx(() => Visibility(
                  visible: controller.vnIsShowLoader.value && controller.lstCategory.isEmpty,
                  replacement: controller.lstCategory.isNotEmpty
                      ? Stack(
                        children: [
                          Padding(
                            ...
                            itemCount: controller.lstCategory.length,
                            itemBuilder: (BuildContext ctx, index) {
                              return InkWell(
                                ...
                                child: CategoriesTile(
                                  category: controller.lstCategory[index],
                                ),
                              );
                            }),
                          ),
