...
class AddRequestScreen extends GetView<AddRequestController> {
  static const route = '/AddRequestScreen';
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        /// : CAR DROP DOWN *
                        Visibility(
                          visible: controller.lstCar.isNotEmpty,
                          child: DropdownButtonHideUnderline(
                            child: DropdownSearch<CarList>(
                              enabled: true,
                              popupProps: PopupProps.bottomSheet(
                                ...
                                title: Container(
                                  ...
                                  height: 70.0,
                                  child: DropDownSearchHelper.getBottomSheetHeaderLayout(titleName: "chooseCar"),
                                ),
                                searchFieldProps: TextFieldProps(
                                  style: context.theme.textTheme.headlineSmall,
                                  controller: controller.tecCarSearchController,
                                  decoration: DropDownSearchHelper.getBottomSheetSearchFieldDecoration(
                                      hintText: "searchCar",
                                      hasFocused: controller.fnSearchCar.hasFocus
                                  ),
                                ),
                                ...
                                itemBuilder: (context, item, isSelected) => Padding(
                                  ...
                                  child: Text(
                                    "${item.brandName} ${item.modelName} ${item.modelTypeName}",
                                    style: context.theme.textTheme.bodyMedium,
                                    overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                              ),
                              selectedItem: controller.selectedCar.value,
                              dropdownButtonProps: DropDownSearchHelper.getDropDownButtonProps(),
                              dropdownDecoratorProps:
                              DropDownSearchHelper.getDropDownDecoratorProps(context, hasFocused: controller.fnSearchCar.hasFocus),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: CustomMarqueeWidget(
                                          child: Text(
                                            selectedItem != null ? "${selectedItem.brandName} ${selectedItem.modelName} ${selectedItem.modelTypeName}" : "chooseCar".translate(),
                              ...
                              items: controller.lstCar,
                              onChanged: (CarList? data) {
                                controller.selectedCar.value = data!;
                                controller.onChangeCar();
                              },
                              itemAsString: (CarList? c){
                                return "${c?.brandName} ${c?.modelName} ${c?.modelTypeName}";
                              },
                            ),
                          ),
                        ),
                        ...
                        DropdownButtonHideUnderline(
                          child: DropdownSearch<ManufacturerData>(
                            ...
                            dropdownButtonProps: DropDownSearchHelper.getDropDownButtonProps(),
                            dropdownDecoratorProps:DropDownSearchHelper.getDropDownDecoratorProps(context, hasFocused: controller.fnSearchManufacturer.hasFocus),
                            dropdownBuilder: (context, selectedItem) {
                              return SizedBox(
                                height: 35.0,
                                child: Row(
