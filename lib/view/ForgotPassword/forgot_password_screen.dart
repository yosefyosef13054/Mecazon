             ...
             child: Obx(
               () => Column(
                 ...
                 children: [
                   ...
                   Text(
                     "forgotPasswordDescription".translate(),
                     textAlign: TextAlign.center,
                       ...
                       children: [
                         SizedBox(
                           ...
                           child: ElevatedButton.icon(
                             onPressed: () {
                               controller.rxIsLoginType.value = LOGIN_TYPE_1;
                             },
                             style: ButtonStyle(
                                 ...
                                 shape: MaterialStateProperty.all(
                                   RoundedRectangleBorder(
                                     ...
                                     side: BorderSide(
                                         width: 1.0,
                                         color: controller.rxIsLoginType.value ==
                                             LOGIN_TYPE_1
                             ...
                             icon: SvgPicture.asset(
                               ...
                               height: 18.0,
                               colorFilter: ColorFilter.mode(controller.rxIsLoginType.value == LOGIN_TYPE_1 ? context.theme.primaryColorDark
                                     : AppColor.appBlackColor, BlendMode.srcIn)
                             ),
                             label: Text(
                               "email".translate(),
                               style: Fonts.regularTextStyle.copyWith(
                                 color: controller.rxIsLoginType.value == LOGIN_TYPE_1
                                     ? context.theme.primaryColorDark
                         ...
                         SizedBox(
                           ...
                           child: ElevatedButton.icon(
                             onPressed: () {
                               controller.rxIsLoginType.value = LOGIN_TYPE_2;
                             },
                             style: ButtonStyle(
                                 backgroundColor: MaterialStateProperty.all(
                                     controller.rxIsLoginType.value == LOGIN_TYPE_2
                             ...
                             icon: SvgPicture.asset(
                                 AssetsHelper.getSVGIcon('ic_call.svg'),
                                 height: 18.0,
                                 colorFilter: ColorFilter.mode(controller.rxIsLoginType.value == LOGIN_TYPE_2 ? context.theme.primaryColorDark
                                     : AppColor.appBlackColor, BlendMode.srcIn)
                             ),
                             label: Text(
                               "mobile".translate(),
                               style: Fonts.regularTextStyle.copyWith(
                                 color: controller.rxIsLoginType.value == LOGIN_TYPE_2
                                     ? context.theme.primaryColorDark
                                     : context.theme.primaryColorLight,
                               ),
                             ),
                             ...
                             child: DropdownButtonHideUnderline(
                               child: DropdownSearch<CountryData>(
                                 ...
                                 popupProps: PopupProps.bottomSheet(
                                   ...
                                   bottomSheetProps:
                                   DropDownSearchHelper.getBottomSheetProps(),
                                 ),
                                 selectedItem: controller.selectedCountry.value,
                                 dropdownButtonProps:
                                 DropDownSearchHelper.getDropDownButtonProps(),
                                 dropdownDecoratorProps:
                                 DropDownSearchHelper.getDropDownDecoratorProps(context,hasFocused: controller.nodes[2].hasFocus),
                   ...
                   ButtonView(
                     ...
                     onPressed: () {
                       if (controller.rxIsLoginType.value == 1) {
                         controller.callForgotPasswordSendOTPAPI();
                       } else {
                         controller.callForgotPasswordSendOTPAPI(isFromMobileNo: true);
                       }
                     },
                   ),
                   CommonWidget.getFieldSpacer(height: 15.0),
